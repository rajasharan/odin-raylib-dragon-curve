...
// include: /var/folders/_6/kxgvlhg57nxgnjlpsz34p2_40000gn/T/tmph1yu69yd.js
...
// end include: /var/folders/_6/kxgvlhg57nxgnjlpsz34p2_40000gn/T/tmph1yu69yd.js
// include: /var/folders/_6/kxgvlhg57nxgnjlpsz34p2_40000gn/T/tmp6v15xc_i.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/_6/kxgvlhg57nxgnjlpsz34p2_40000gn/T/tmp6v15xc_i.js
// include: /var/folders/_6/kxgvlhg57nxgnjlpsz34p2_40000gn/T/tmp5u4yc821.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/_6/kxgvlhg57nxgnjlpsz34p2_40000gn/T/tmp5u4yc821.js
...
var ASM_CONSTS = {
  129120: () => { if (document.fullscreenElement) return 1; },  
 129166: () => { return document.getElementById('canvas').width; },  
 129218: () => { return parseInt(document.getElementById('canvas').style.width); },  
 129286: () => { document.exitFullscreen(); },  
 129313: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 129386: () => { if (document.fullscreenElement) return 1; },  
 129432: () => { return document.getElementById('canvas').width; },  
 129484: () => { return screen.width; },  
 129509: () => { document.exitFullscreen(); },  
 129536: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 129669: () => { return window.innerWidth; },  
 129695: () => { return window.innerHeight; },  
 129722: () => { if (document.fullscreenElement) return 1; },  
 129768: () => { return document.getElementById('canvas').width; },  
 129820: () => { return parseInt(document.getElementById('canvas').style.width); },  
 129888: () => { if (document.fullscreenElement) return 1; },  
 129934: () => { return document.getElementById('canvas').width; },  
 129986: () => { return screen.width; },  
 130011: () => { return window.innerWidth; },  
 130037: () => { return window.innerHeight; },  
 130064: () => { if (document.fullscreenElement) return 1; },  
 130110: () => { return document.getElementById('canvas').width; },  
 130162: () => { return screen.width; },  
 130187: () => { document.exitFullscreen(); },  
 130214: () => { if (document.fullscreenElement) return 1; },  
 130260: () => { return document.getElementById('canvas').width; },  
 130312: () => { return parseInt(document.getElementById('canvas').style.width); },  
 130380: () => { document.exitFullscreen(); },  
 130407: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 130465: () => { return screen.width; },  
 130490: () => { return screen.height; },  
 130516: () => { return window.screenX; },  
 130543: () => { return window.screenY; },  
 130570: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 130623: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 130694: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 130751: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 131007: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 131078: () => { if (document.fullscreenElement) return 1; },  
 131124: () => { return window.innerWidth; },  
 131150: () => { return window.innerHeight; },  
 131177: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
